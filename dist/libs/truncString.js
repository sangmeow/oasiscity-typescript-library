 ...
 */
const truncString = (str, length, padString = '_') => {
    ...
    if (typeof padString !== 'string' || padString.length === 0 || padString === undefined || padString === null) {
...
//# sourceMappingURL=truncString.js.map