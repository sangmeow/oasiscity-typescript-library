 ...
 */
function sanitizeHtml(input: string, allowedTags: string[] = ['b', 'i', 'em', 'strong']): string {
 ...
 * 입력값 검증 및 정화
 */
function validateAndSanitizeInput(input: string, maxLength: number = 1000): string {
 ...
 * DOM에 안전하게 텍스트 삽입
 */
function safeSetTextContent(element: HTMLElement, text: string): void {
 ...
 */
function safeSetInnerHTML(element: HTMLElement, html: string, allowedTags?: string[]): void {
