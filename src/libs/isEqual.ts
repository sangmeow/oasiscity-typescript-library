 ...
 * @category Equality
 */
export const isEqualString = (input: unknown, target: string): input is string => {
 ...
 * @category Equality
 */
export const isEqualNumber = (input: unknown, target: number): input is number => {
 ...
 * @category Equality
 */
export const isEqualBoolean = (input: unknown, target: boolean): input is boolean => {
 ...
 * @category Equality
 */
export const isNotEqualString = (input: unknown, target: string): boolean => {
  return !isString(input) || input !== target;
};
 ...
 * @category Equality
 */
export const isNotEqualNumber = (input: unknown, target: number): boolean => {
  return !isNumber(input) || input !== target;
};
 ...
 * @category Equality
 */
export const isEqual = (input: unknown, target: unknown): boolean => {
 ...
 * @category Equality
 */
export const isLooseEqual = (input: unknown, target: unknown): boolean => {
 ...
 * @category Equality
 */
export const isDeepEqual = (input: unknown, target: unknown): boolean => {
  ...
  if (isPlainObject(input) && isPlainObject(target)) {
    ...
    return inputKeys.every(key => 
      ...
      isDeepEqual(input[key], target[key])
    );
  }
 ...
 * @category Utilities
 */
export const matchesPattern = (value: unknown, pattern: RegExp | string): value is string => {
  if (!isString(value)) {
    return false;
  }
 ...
 * @category Utilities
 */
export const hasMethod = <K extends string | number | symbol>(
  value: unknown,
  methodName: K
 ...
 * @category Utilities
 */
export const createInstanceGuard = <T>(
